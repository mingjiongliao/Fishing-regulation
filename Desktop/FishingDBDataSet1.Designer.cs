...
namespace Desktop {
    ...
    public partial class FishingDBDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/FishingDBDataSet1.xsd";
        ...
        public partial class TICKETDataTable : global::System.Data.TypedTableBase<TICKETRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TICKETRow AddTICKETRow(string PROVINCE, bool VALID, int TICKET_ID) {
        ...
        public partial class TICKETRow : global::System.Data.DataRow {
            ...
            public string PROVINCE {
                get {
                    return ((string)(this[this.tableTICKET.PROVINCEColumn]));
                }
                set {
                    this[this.tableTICKET.PROVINCEColumn] = value;
                }
            }
            ...
            public bool VALID {
                get {
                    return ((bool)(this[this.tableTICKET.VALIDColumn]));
                }
                set {
                    this[this.tableTICKET.VALIDColumn] = value;
                }
            }
...
namespace Desktop.FishingDBDataSet1TableAdapters {
    ...
    public partial class TICKETTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TICKET] WHERE (([PROVINCE] = @Original_PROVINCE) AND ([VALID] " +
                "= @Original_VALID) AND ([TICKET_ID] = @Original_TICKET_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TICKET] ([PROVINCE], [VALID], [TICKET_ID]) VALUES (@PROVINCE, " +
                "@VALID, @TICKET_ID);\r\nSELECT PROVINCE, VALID, TICKET_ID FROM TICKET WHERE (TICKE" +
                "T_ID = @TICKET_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TICKET] SET [PROVINCE] = @PROVINCE, [VALID] = @VALID, [TICKET_ID] = @TICKET_ID WHERE (([PROVINCE] = @Original_PROVINCE) AND ([VALID] = @Original_VALID) AND ([TICKET_ID] = @Original_TICKET_ID));
SELECT PROVINCE, VALID, TICKET_ID FROM TICKET WHERE (TICKET_ID = @TICKET_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PROVINCE, VALID, TICKET_ID FROM dbo.TICKET";
        ...
        public virtual int Fill(FishingDBDataSet1.TICKETDataTable dataTable) {
        ...
        public virtual FishingDBDataSet1.TICKETDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FishingDBDataSet1.TICKETDataTable dataTable = new FishingDBDataSet1.TICKETDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FishingDBDataSet1.TICKETDataTable dataTable) {
        ...
        public virtual int Delete(string Original_PROVINCE, bool Original_VALID, int Original_TICKET_ID) {
        ...
        public virtual int Insert(string PROVINCE, bool VALID, int TICKET_ID) {
            if ((PROVINCE == null)) {
        ...
        public virtual int Update(string PROVINCE, bool VALID, int TICKET_ID, string Original_PROVINCE, bool Original_VALID, int Original_TICKET_ID) {
            if ((PROVINCE == null)) {
                throw new global::System.ArgumentNullException("PROVINCE");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(Original_VALID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PROVINCE, bool VALID, string Original_PROVINCE, bool Original_VALID, int Original_TICKET_ID) {
            return this.Update(PROVINCE, VALID, Original_TICKET_ID, Original_PROVINCE, Original_VALID, Original_TICKET_ID);
        }
    }
